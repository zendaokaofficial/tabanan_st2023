...
def highlight_survived(s):
    if ((s['Jumlah Dokumen L2 PPL ke PML'].astype(int) > s['Jumlah Dokumen L2 Terpakai'].astype(int)) or (s['Jumlah Dokumen L2 PML ke Koseka'].astype(int) > s['Jumlah Dokumen L2 Terpakai'].astype(int)) or (s['Jumlah Dokumen L2 PML ke Koseka'].astype(int) > s['Jumlah Dokumen L2 PPL ke PML'].astype(int)) or (s['Jumlah RTUP Tercacah'].astype(int) > s['Jumlah Dokumen L2 Terpakai'].astype(int))):
