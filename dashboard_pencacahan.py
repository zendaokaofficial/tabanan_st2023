...
def highlight_survived(s):
    if ((s['Jumlah Dokumen L2 PPL ke PML'] > s['Jumlah Dokumen L2 Terpakai']) or (s['Jumlah Dokumen L2 PML ke Koseka'] > s['Jumlah RTUP Tercacah']) or (s['Jumlah Dokumen L2 PML ke Koseka'] > s['Jumlah Dokumen L2 PPL ke PML']) or (s['Jumlah RTUP Tercacah'] > s['Jumlah Dokumen L2 Terpakai'])):
